...
- (void)viewWillAppear:(BOOL)animated {
    ...
    [self.webView.configuration.userContentController addScriptMessageHandler:self name:@"myAlert"];
...
- (void)webView:(WKWebView *)webView didFinishNavigation:(null_unspecified WKNavigation *)navigation{
    ...
    NSString * path  = [[NSBundle mainBundle] pathForResource:@"haha" ofType:@"js"];
